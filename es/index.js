...
import { getLen, getRotateAngle, getMovingDirection, getDirectionEventName } from './utils';
  ...
  function TouchFinger(el, options) {
    ...
    this.handleTouchStart = function (e) {
      ...
      if (len > 1) {
        ...
        _this.gestureStatus.pinchStartLen = getLen(preV);
      ...
      if (len > 1) {
        ...
        if (preV.x !== null) {
          if (_this.gestureStatus.pinchStartLen > 0) {
            e.zoom = getLen(v) / _this.gestureStatus.pinchStartLen;
        ...
        var direction = getMovingDirection(e.deltaX, e.deltaY);
